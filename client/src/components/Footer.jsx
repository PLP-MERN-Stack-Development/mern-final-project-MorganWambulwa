    ...
    <footer className="bg-gray-900 text-gray-100 pt-20 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4 text-gray-400">
              ...
              <li><Link to="/auth" className="hover:text-emerald-400 transition-colors">Donate Food</Link></li>
              <li><Link to="/auth" className="hover:text-emerald-400 transition-colors">Request Food</Link></li>
        ...
        <div className="border-t border-gray-800 pt-8 text-center text-gray-500">
          <p>&copy; 2025 FoodShare Kenya. All rights reserved. Built for Zero Hunger.</p>
        </div>
      </div>
    </footer>
  );
